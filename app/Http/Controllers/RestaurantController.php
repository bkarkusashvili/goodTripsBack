...
{
    protected $model = 'App\Restaurant';

    protected $select = ['id', 'title_ka', 'title_en', 'address_ka', 'address_en', 'description_ka', 'description_en', 'author_ka', 'author_en', 'services', 'website', 'email', 'mobile', 'location', 'gallery', 'image_id', 'foods'];
    ...
    protected $asideInputs = [
        ...
        [ 'name' => 'foods', 'type' => 'select', 'title' => 'საკვები', 'multiple' => true ],
    ...
    public function __construct() {
        ...
        $this->asideInputs[1]['options'] = [
            ['value' => '', 'title' => ''],
            Food::select('id as value', 'title_ka as title')->get()
        ];
    }
